...
class Ui_FileExplorer(object):
    def setupUi(self, FileExplorer):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("svg/app_finder_bright_icon.pgm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgb(243, 243, 243);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/svgs/svg/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deleteLeft.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/svgs/svg/folder.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addDirectoryLeft.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/svgs/svg/file.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addFileLeft.setIcon(icon3)
        ...
        self.deleteRight.setIcon(icon1)
        ...
        self.addDirectoryLeft_2.setIcon(icon2)
        ...
        self.addFileLeft_2.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/svgs/svg/left2right.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.left2right.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/svgs/svg/right2left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.right2left.setIcon(icon5)
